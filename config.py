...
# Esto detecta automáticamente la carpeta donde tienes el proyecto
...
# Cambia las IPs de la universidad por localhost
CALL_PALAVRAS_FLAT = 'http://127.0.0.1:9999'
CALL_PALAVRAS_TREE = 'http://127.0.0.1:9999'
...
# Configuración de base de datos para NILC-Metrix
# Busca estas líneas y cámbialas así:
DB_HOST = 'localhost'      # Cambia 'pgs_cohmetrix' por 'localhost'
DB_USER = 'postgres'
DB_NAME = 'cohmetrix_pt_br'
DB_PORT = 5433             # Asegúrate de que sea 5433 como vimos en pgAdmin
DB_PASS = ''               # Vacío si estás en modo trust