...
DEFAULT_OPTIONS = {
    'dialect': 'postgresql',
    'driver': 'psycopg2',
    'username': 'postgres',   # Cambiado de 'cohmetrix'
    'password': '',           # Tu contraseña está vacía (modo trust)
    'host': 'localhost',      # Cambiado de 'pgs_cohmetrix'
    'port': '5433',           # Tu puerto es el 5433
    'database': 'cohmetrix_pt_br', # El nombre de tu DB restaurada
}
